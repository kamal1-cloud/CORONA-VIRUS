var testBtn = document.getElementById('start-btn');
var questions = document.getElementById('container');
var preambule = document.getElementById('pre-info');
const scroll = document.querySelectorAll('.stepper h1');
const nextButton = document.getElementById('next-btn');
const question = document.getElementById('nextQuestion');
const selectInputs = document.querySelector('.answer-inputs');
const previousBtn = document.getElementById('pré-btn');
